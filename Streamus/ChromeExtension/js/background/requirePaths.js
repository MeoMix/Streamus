var require = {
    baseUrl: '../',
    paths: {
        'main': 'ChromeExtension/js/background/main',
        'programState': 'ChromeExtension/js/programState',
        'background': 'ChromeExtension/js/background/background',
        'playlistDataProvider': 'ChromeExtension/js/background/playlistDataProvider',
        ...
        'playlistManager': 'ChromeExtension/js/background/playlistManager',
        'videoManager': 'ChromeExtension/js/background/videoManager',
        ...
        'user': 'ChromeExtension/js/background/user',
        'oauth2': 'Shared/js/thirdParty/oauth2/oauth2',
        'playlistItem': 'ChromeExtension/js/background/playlistItem',
