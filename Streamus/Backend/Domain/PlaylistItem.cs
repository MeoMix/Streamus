...
namespace Streamus.Backend.Domain
{
    ...
    public class PlaylistItem
    {
        ...
        public string VideoId
        {
            get
            {
                return Video == null ? string.Empty : Video.Id;
            }
            set
            {
                if (Video == null || Video.Id != value)
                {
                    Video = new VideoDao().Get(value);
                }
            }
        }
        ...
        public PlaylistItem(Guid playlistId, Guid id, string title, string videoId)
            : this()
        {
        ...
        public void CopyFromDetached(PlaylistItem detachedItem)
        {
            ...
            NextItemId = detachedItem.NextItemId;
            PreviousItemId = detachedItem.PreviousItemId;
